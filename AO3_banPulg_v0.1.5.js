...
(function () {
  ...
  mainDivCover.innerHTML = `
    <div class="vpv-AO3-main-con">
      ...
      <h3 class="title">AO3插件 v0.1.5</h3>
  ...
  if (JSON.parse(localSetting)) {
    ...
    settingItems[5].checked = setting.useBanOrphans;
  }
  ...
  */
  ...
  btnClearInvaildAuthors.addEventListener('click', () => {
    ...
    clearListTip.innerHTML = '正在处理，请稍后（请勿重复点击）'
  ...
  */
  ...
  btnSaveSetting.addEventListener('click', () => {
    ...
    setting.useBanOrphans = settingItems[5].checked;
